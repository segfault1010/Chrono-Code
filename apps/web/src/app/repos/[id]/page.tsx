...
export default function RepoPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto p-4 sm:p-8 animate-fade-in">
      ...
      {/* ================================================================= */}
      <header className="mb-8 sticky top-0 z-40 bg-black/80 backdrop-blur-2xl border-b border-white/5 py-4 -mx-4 px-4 sm:-mx-8 sm:px-8 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white flex items-center gap-2">
              <span className="text-white/40 font-medium">{repo.owner}</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <Button 
              ...
              isLoading={isSaving}
              className={`flex-1 sm:flex-none flex items-center justify-center gap-2 rounded-lg transition-all duration-300 h-9 px-4 text-sm font-bold ${isSaved ? "bg-white/5 border border-white/10 text-white hover:bg-white/10" : "bg-white border border-transparent text-black hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]"}`}
            >
              {isSaved ? (
                <>
